...
sec "CORE"
cmd "Gegenschuss_farm_control.sh" "Interactive launcher"
...
dcmd "  --script scripts/core/shutdown.sh -- --postjob"
dlabel "Post-job shutdown:"
dcmd "scripts/core/shutdown.sh --postjob"
